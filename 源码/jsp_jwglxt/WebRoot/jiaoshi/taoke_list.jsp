  ...
  <tr>
    <td class="border_left border_right border_bottom" height="400" valign="top" align="center"><table border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0" bgcolor="#999999">
        <tr class="tabletop">
          <td height="25" colspan="12" align="center">选修列表</td>
        </tr>
        <tr class="tablemenu">
          <td height="20" align="center">序号</td>
          <td height="20" align="center">学生姓名</td>
          <td height="20" align="center">选课时间</td>
          <td height="20" align="center">选课原因</td>
        ...
        <%} %>
        <tr class="tabletop">
          <td height="25" colspan="12" align="center"><a href="<%=path %>/jiaoshi/taoke.jsp?mark=add">添加选课学生</a></td>
        </tr>
      </table></td>
  </tr>
</table>
